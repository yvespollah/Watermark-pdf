...
function App() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const apiUrl = import.meta.env.VITE_API_URL || (import.meta.env.DEV ? 'http://localhost:3002' : '');
        ...
        <div className="text-center mb-8 md:mb-12">
          <div className="flex flex-col sm:flex-row items-center justify-center mb-4 gap-3">
            ...
            <h1 className="text-2xl sm:text-3xl md:text-4xl font-bold text-gray-800 text-center">
              SchoolForAll PDF Watermark
            </h1>
          </div>
          <p className="text-gray-600 text-base sm:text-lg px-4">
            Add professional watermarks to your PDF documents
          </p>
        </div>
        ...
        <div className="max-w-6xl mx-auto grid grid-cols-1 md:grid-cols-2 gap-4 sm:gap-6 md:gap-8">
          ...
          <div className="bg-white rounded-lg shadow-lg p-4 sm:p-6 md:p-8">
            <h2 className="text-xl sm:text-2xl font-semibold mb-4 sm:mb-6 flex items-center text-gray-800">
              <Upload className="w-5 h-5 sm:w-6 sm:h-6 mr-2 text-indigo-600" />
              Upload PDF
            </h2>
            ...
            <div
              ...
              className="border-2 border-dashed border-indigo-300 rounded-lg p-6 sm:p-8 md:p-12 text-center hover:border-indigo-500 transition-colors cursor-pointer bg-indigo-50"
            >
              <input
                type="file"
              ...
              <label htmlFor="file-upload" className="cursor-pointer">
                <FileText className="w-12 h-12 sm:w-14 sm:h-14 md:w-16 md:h-16 mx-auto mb-3 sm:mb-4 text-indigo-400" />
                <p className="text-sm sm:text-base text-gray-600 mb-2 break-words px-2">
          ...
          <div className="bg-white rounded-lg shadow-lg p-4 sm:p-6 md:p-8">
            <h2 className="text-xl sm:text-2xl font-semibold mb-4 sm:mb-6 flex items-center text-gray-800">
              <Settings className="w-5 h-5 sm:w-6 sm:h-6 mr-2 text-indigo-600" />
              Watermark Settings
            </h2>
            ...
            <form onSubmit={handleSubmit} className="space-y-4 sm:space-y-6">
              ...
              <div>
                ...
                <div className="flex items-center space-x-3">
                  ...
                  <input
                    ...
                    value={color}
                    onChange={(e) => setColor(e.target.value)}
                    className="flex-1 px-3 py-2 sm:px-4 text-sm sm:text-base border border-gray-300 rounded-lg focus:ring-2 focus:ring-indigo-500 focus:border-transparent"
                  />
                </div>
              </div>
              ...
              <button
                ...
                className="w-full bg-indigo-600 text-white py-2.5 sm:py-3 px-4 sm:px-6 rounded-lg text-sm sm:text-base font-semibold hover:bg-indigo-700 disabled:bg-gray-400 disabled:cursor-not-allowed transition-colors flex items-center justify-center"
              >
                {isProcessing ? (
                  <>
